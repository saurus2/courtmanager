      ...
      <div className='mt-4 flex items-center'>
        ...
        {!readOnly && (
          <button
            ...
            className={`px-4 py-2 rounded-md ml-2 ${isChangeAllowed ? 'bg-green-500 text-white' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
              }`}
          >
            Change Players
          </button>
        ...
        {!readOnly && (
          <button
            ...
            className={`px-4 py-2 rounded-md ml-2 ${assignClicked
        ...
        {!readOnly && (
          <button
            ...
            className={`px-4 py-2 rounded-md ml-2 flex items-center justify-center ${isRollbackAllowed
